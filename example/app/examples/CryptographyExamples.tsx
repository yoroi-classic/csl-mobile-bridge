...
export default class CryptographyExamples {
  static async run(): Promise<ExampleSection> {
    ...
    try {
      ...
      validate(
        results,
        'Private key from hex round-trip',
        privKeyHex,
        privKeyFromHex.to_hex()
      );
      ...
      validate(
        results,
        'Private key from normal bytes round-trip',
        privateKey.to_hex(),
        privKeyFromNormalBytes.to_hex()
      );

      const extendedKeyBytes = extendedPrivateKey.as_bytes();
      const extendedFromBytes =
        PrivateKey.from_extended_bytes(extendedKeyBytes);
      validate(
        results,
        'Extended private key from bytes round-trip',
        extendedPrivateKey.to_hex(),
        extendedFromBytes.to_hex()
      );
      ...
      validate(
        results,
        'Private key from bech32 round-trip',
        privKeyHex,
        privKeyFromBech32.to_hex()
      );
      ...
      validate(
        results,
        'Public key from bech32 round-trip',
        publicKey.to_hex(),
        pubKeyFromBech32.to_hex()
      );
      ...
      validate(
        results,
        'Vkey public key matches original',
        publicKey.to_hex(),
        vkeyPubKey.to_hex()
      );
      ...
      validate(
        results,
        'Vkey from bytes round-trip',
        vkey.to_hex(),
        vkeyFromBytes.to_hex()
      );
      ...
      validate(
        results,
        'Vkeywitness signature matches',
        signature.to_hex(),
        witnessSignature.to_hex()
      );
      ...
      validate(
        results,
        'Bip32 from 128 xprv round-trip',
      ...
      validate(
        results,
        'Bip32 from bytes round-trip',
        bip32PrivateKey.to_hex(),
        bip32FromBytes.to_hex()
      );
      ...
      validate(
        results,
        'Bip32 from bech32 round-trip',
        bip32PrivateKey.to_hex(),
        bip32FromBech32.to_hex()
      );
      ...
      validate(
        results,
        'Bip32 public key from bytes round-trip',
        bip32PubKey.to_hex(),
        pub32FromBytes.to_hex()
      );
      ...
      validate(
        results,
        'Bip32 public key from bech32 round-trip',
        bip32PubKey.to_hex(),
        pub32FromBech32.to_hex()
      );
      ...
      validate(
        results,
        'Bip32 public key from hex round-trip',
        pub32Hex,
        pub32FromHex.to_hex()
      );
      ...
      validate(
        results,
        'Ed25519Signature from bytes round-trip',
        signature.to_hex(),
        sigFromBytes.to_hex()
      );
      ...
      validate(
        results,
        'Ed25519Signature from hex round-trip',
        sigHex,
        sigFromHex.to_hex()
      );
      ...
      validate(
        results,
        'Ed25519Signature from bech32 round-trip',
        signature.to_hex(),
        sigFromBech32.to_hex()
      );
      ...
      validate(
        results,
        'Ed25519KeyHash from bytes round-trip',
        keyHash.to_hex(),
        keyHashFromBytes.to_hex()
      );
      ...
      validate(
        results,
        'Ed25519KeyHash from hex round-trip',
        keyHashHex,
        keyHashFromHex.to_hex()
      );
      ...
      validate(
        results,
        'Ed25519KeyHash from bech32 round-trip',
        keyHash.to_hex(),
        keyHashFromBech32.to_hex()
      );
    } catch (error) {
      results.push(
